...
public class LoggerUtils {
    private final Logger logger = LogManager.getLogger("McEnchantGrind");
    ...
    public void printStartup() {
        ...
        String reset = "\u001B[0m";
        String software = McEnchantGrind.getInstance().getServer().getName();
        String version = McEnchantGrind.getInstance().getServer().getVersion();
